        ...
        <div class="bPageBlock">
            ...
            <div class="pbBody">
                ...
                <div class="brandTertiaryBrd pbSubheader tertiaryPalette">
                    <h3>富文本区域 选项<span class="titleSeparatingColon">:</span></h3>
                </div>
                <div class="pbSubsection">
                    <table class="detailList">
                        <tbody>
                            <tr>
                                <td class="last labelCol">可见行数</td>
                                <td class="dataCol last col02">{{detail.Precision}}</td>
                                <td class="last labelCol">长度</td>
                                <td class="last dataCol">{{detail.Length}}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>

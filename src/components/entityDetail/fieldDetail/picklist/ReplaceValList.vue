            ...
            <div class="pbBody">
                <div class="pbSubsection">
                    <table class="detailList" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr class="detailRow"><td colspan="4"><img src="@/assets/img/s.gif" alt="" width="1" height="5" title=""></td></tr><tr><td class="labelCol">要更改的确切值</td><td class="data2Col" colspan="3"><input type="hidden" id="ids" name="ids" value="01J9000000T1Qgg">1 选项列表值</td></tr>
                            <tr><td class="last labelCol"><label for="nv">选择要更改至的目标值</label></td><td class="dataCol last col02"><select id="nv" name="nv"><option value="">--无--</option><option value="2">Yes</option>

<template>
    <div class="bPageBlock bEditBlock ">
        ...
        <div class="pbBody">
            ...
            <div class="pbSubheader brandTertiaryBgr tertiaryPalette">
                <h3>自动编号 选项<span class="titleSeparatingColon">:</span></h3>
            </div>
            <div class="pbSubsection">
                <table class="detailList">
                    <tbody>
                        <tr>
                            <td class="last labelCol">
                                <label for="AutoNumberMask">自动编号显示格式</label>
                            </td>
                            <td class="dataCol last col02">
                                <input id="AutoNumberMask" maxlength="90" name="AutoNumberMask" v-model="formState.AutoNumberMask" size="20" tabindex="16" type="text">
                            </td>
                            <td class="labelCol last empty">&nbsp;</td>
                            <td class="dataCol last empty">&nbsp;</td>
                        </tr>
...
<script setup>
    ...
    onMounted(()=>{
        ...
        // let { label, entityLabel, developerName, Description, InlineHelpText, IsExternalIdentifier, AutoNumberMask } = props.detail;
        ...
        // formState.AutoNumberMask = AutoNumberMask;

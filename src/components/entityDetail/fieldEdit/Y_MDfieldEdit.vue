                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="data2Col" colspan="3">
                                <textarea cols="100" id="fa_description" maxlength="1000" name="fa_description" v-model="formState.Description" type="text" wrap="soft"></textarea>
                            </td>
                        </tr>
                        <tr>
                ...
                <table class="detailList">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="data2Col" colspan="3">
                                选择主记录上所需的最小访问级别以创建、编辑或删除相关详细信息记录：
                                <ul class="radioGroup" id="OptionsFlag_13" name="OptionsFlag_13">
                                    <li><input id="OptionsFlag_131" name="OptionsFlag_13" tabindex="18" type="radio" value="1" v-model="formState.OptionsFlag_13"><label for="OptionsFlag_131">只读：允许至少对主记录拥有读取访问权限的用户创建、编辑或删除相关详细信息记录。</label></li>
                                    <li><input checked="checked" id="OptionsFlag_130" name="OptionsFlag_13" tabindex="19" type="radio" value="0" v-model="formState.OptionsFlag_13"><label for="OptionsFlag_130">读/写：允许至少对主记录拥有读/写访问权限的用户创建、编辑或删除相关详细信息记录。</label></li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                            <td class="last labelCol">允许重新设置父级</td>
                            <td class="last data2Col" colspan="3"><input id="options_20" name="options_20" tabindex="21" type="checkbox" v-model="formState.options_20">子记录在被创建后可重新设置父级至其他父级记录</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<script setup>
    ...
    const { complianceGroups, complianceGroup_unselected, complianceGroupSelecteds,
         complianceGroup_selected, FilterExpresssionList, entityId, isFilter } = toRefs(data);
...
<style lang="less" scoped>
    ...
    #lookupFilterSection_link:hover{
        color: #015ba7;
    }
</style>
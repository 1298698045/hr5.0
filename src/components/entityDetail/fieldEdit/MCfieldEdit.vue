<template>
    <div class="bPageBlock bEditBlock ">
        ...
        <div class="pbBody">
                ...
                <table class="detailList">
                    <tbody>
                        <tr>
                            ...
                            <td class="data2Col" colspan="3"><input id="options_0" name="options_0" type="checkbox" value="1">此字段中总是需要一个值来保存记录</td>
                        </tr>
                        <FormulaEditor
            ...
            <div class="pbSubheader brandTertiaryBgr tertiaryPalette">
                <h3>选项列表（多项选择） 选项<span class="titleSeparatingColon">:</span></h3>
            </div>
            <div class="pbSubsection">
                <table class="detailList">
                    <tbody>
                        <tr>
                            ...
                            <td class="dataCol col02">
                                <input checked="checked" disabled="disabled" id="pickopts_1" name="pickopts_1" type="checkbox" v-if="formState.pickopts_1">
                        ...
                        <tr>
                            ...
                            <td class="dataCol last col02">
                                <div class="requiredInput">
                                    <div class="requiredBlock"></div>
                                    <input id="Precision" maxlength="2" name="Precision" size="20" tabindex="24" type="text" v-model="formState.Precision">
                                    <div class="errorMsg" v-if="rules.Precision.isRequired"><strong>错误:</strong> 必须输入一个值</div>
                                </div>
                            </td>
                            <td class="labelCol last empty">&nbsp;</td>
                            <td class="dataCol last empty">&nbsp;</td>
...
<script setup>
    ...
    onMounted(()=>{
        ...
        // let { label, entityLabel, developerName, Description, InlineHelpText, options_0, Precision
        //  } = props.detail;

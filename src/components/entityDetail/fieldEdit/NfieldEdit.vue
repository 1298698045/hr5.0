            ...
            <tr>
              ...
              <td class="data2Col" colspan="3">
                <input
                  ...
                  tabindex="17"
                  type="checkbox"
                  v-model="formState.IsUnique"
                />不允许重复值
              </td>
            </tr>
            <tr>
              <td class="labelCol">
                <label for="IsExternalIdentifier">外部 ID</label>
              </td>
              <td class="data2Col" colspan="3">
                <input
                  id="IsExternalIdentifier"
                  name="IsExternalIdentifier"
                  tabindex="19"
                  type="checkbox"
                  v-model="formState.IsExternalIdentifier"
                />将此字段设置为针对外部系统的唯一记录标识符
              </td>
            </tr>
            <FormulaEditor
          ...
          <tbody>
              ...
              <td class="dataCol col02">
                <div class="requiredInput">
                  ...
                  <input
                    id="digleft"
                    name="digleft"
                    v-model="formState.digleft"
                    size="20"
                    tabindex="21"
                    type="text"
                  />
                  <div class="errorMsg" v-if="rules.digleft.isRequired">
                    <strong>错误:</strong> 必须输入一个值
                  </div>
                </div>
              </td>
            ...
            <tr>
              <td class="labelCol last requiredInput">
                <label for="Scale"
                  ><span class="assistiveText">*</span>小数位数</label
                >
              </td>
              <td class="dataCol last col02">
                <div class="requiredInput">
                  ...
                  <input
                    ...
                    type="text"
                  />
                  <div class="errorMsg" v-if="rules.Scale.isRequired">
                    <strong>错误:</strong> 必须输入一个值
                  </div>
                </div>
              </td>

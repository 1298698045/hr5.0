            ...
            <div class="pbSubsection">
                <table class="detailList">
                    <tbody>
                        ...
                        <tr><td class="labelCol"><label for="IsUnique">独有</label></td><td class="data2Col" colspan="3"><input id="IsUnique" name="IsUnique" tabindex="17" type="checkbox" v-model="formState.IsUnique">不允许重复值</td></tr>
                        <tr><td class="labelCol"><label for="IsExternalIdentifier">外部 ID</label></td><td class="data2Col" colspan="3"><input id="IsExternalIdentifier" name="IsExternalIdentifier" tabindex="19" type="checkbox" v-model="formState.IsExternalIdentifier">将此字段设置为针对外部系统的唯一记录标识符</td></tr>
                        <FormulaEditor

        ...
        <div class="pbBody">
                ...
                <table class="detailList">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="data2Col" colspan="3">
                                <textarea id="fa_description" maxlength="1000" name="fa_description" v-model="formState.fa_description" type="text" wrap="soft"></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="pbSubsection">
                <table class="detailList">
                    <tbody>
                        <tr>
                            <td class="labelCol"><label for="IsExternalIdentifier">外部 ID</label></td><td class="data2Col" colspan="3">
                                <input id="IsExternalIdentifier" name="IsExternalIdentifier" tabindex="19" type="checkbox" v-model="formState.IsExternalIdentifier">将此字段设置为针对外部系统的唯一记录标识符
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="detailList">
                    <tbody>
                        <tr>
                            ...
                            <td class="data2Col" colspan="3">
                                <input checked="checked" id="options_190" name="options_19" v-model="formState.options_19" tabindex="18" type="radio" value="0">
                                <label for="options_190">度数、分钟、秒钟</label>&nbsp;&nbsp;&nbsp;&nbsp;
                                <input id="options_191" name="options_19" v-model="formState.options_19" tabindex="19" type="radio" value="1">
                        ...
                        <tr>
                            ...
                            <td class="dataCol last col02">
                                <div class="requiredInput">
                                    <div class="requiredBlock"></div>
                                    <input id="Scale" name="Scale" type="text" v-model="formState.Scale">
...
<script setup>
    ...
    onMounted(()=>{
        ...
        // let { label, entityLabel, developerName, Description, InlineHelpText, options_0, options_19, Scale
        //  } = props.detail;
        ...
        // formState.options_19 = options_19;

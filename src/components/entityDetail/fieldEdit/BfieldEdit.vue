                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="dataCol last col02">
                                <input id="DefaultValue1" name="DefaultValue" tabindex="16" type="radio" :value="1" v-model="DefaultValue">
                                <label for="DefaultValue1">选取的</label>
                                <br>
                                <input checked="checked" id="DefaultValue0" name="DefaultValue" tabindex="17" type="radio" :value="0" v-model="DefaultValue">
                                <label for="DefaultValue0">未选取的</label>
                            </td>
                            <td class="labelCol last empty">&nbsp;</td>
                            <td class="dataCol last empty">&nbsp;</td>
                        </tr>
...
<script setup>
    ...
    const { complianceGroups, complianceGroup_unselected, complianceGroupSelecteds, complianceGroup_selected, DefaultValue } = toRefs(data);
    ...
    watch(()=> data.DefaultValue, (newVal, oldVal)=>{
        formState.DefaultValue = newVal;
    })
    ...
    onMounted(()=>{
        ...
        // data.DefaultValue = formState.DefaultValue;
    });
    const validateField = () => {
        let isValidate = true;
        let obj = toRaw(rules);

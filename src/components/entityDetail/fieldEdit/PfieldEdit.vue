                ...
                <table class="detailList">
                    <tbody>
                        <tr>
                            ...
                            <td class="data2Col" colspan="3"><input id="options_0" name="options_0" type="checkbox" v-model="formState.options_0">此字段中总是需要一个值来保存记录</td>
                        </tr>
                        <FormulaEditor
                ...
                <table class="detailList">
                    <tbody>
                        <tr>
                            <td class="labelCol requiredInput">
                                <label for="digleft">
                                    <span class="assistiveText">*</span>长度
                                </label>
                            </td>
                            <td class="dataCol col02">
                                <div class="requiredInput">
                                    <div class="requiredBlock"></div>
                                    <input id="digleft" name="digleft" type="text" v-model="formState.digleft">
...
<script setup>
    ...
    onMounted(()=>{
        ...
        // let { label, entityLabel, developerName, Description, InlineHelpText, options_0, digleft, Scale
        //  } = props.detail;

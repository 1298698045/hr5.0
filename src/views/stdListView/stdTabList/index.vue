      ...
      <a-row>
          ...
          >
            ...
            <div style="height: 100%" ref="contentRef">
              ...
              <div class="wea-tabContent" :style="{height:tableHeight-75+'px'}" ref="tabContent">
                <Dtable ref="gridRef" :columns="columns" :gridUrl="gridUrl" :tableHeight="tableHeight-75" :isCollapsed="isCollapsed"></Dtable>
...
<script setup>
  ...
  let data = reactive({
    ...
    activeKey: 0,
    queryParams: {
      entityType: route.params.entityType||121,
      //objectTypeCode: 121,
      search: "",
      filterId: ""
    },
    ...
    filterListFixed: [],
    entityType: route.params.entityType||121,
    sObjectName: route.params.sObjectName||'WFProcess',
    initialData: {}, // 元数据
    actionList: [],
    title: "",
    desc:{
...
const imgUrl = require("@/assets/flow/checkbox_checked.gif");
  ...
  const getMetadataInitialLoad = async () => {
    ...
    await proxy.$get(Interface.listView.getMetadataInitialLoad, {
      name: "",
      entityType: data.entityType||121,
      sObjectName: data.sObjectName||'WFProcess'
    }).then(res=>{
    ...
    let obj = {
      actions:[{
        ...
        params: {
          recordId: null,
          context: "LIST_VIEW",
          entityApiName: data.sObjectName || 'WFProcess',
          record: null,
...
<style lang="less">
    ...
    @import "@/style/stdlistView/stdTabList.less";
</style>
<style lang="less" scoped>
  .home{
    height: 100vh;
  }
  .home .todo-content .ant-row .wea-tab{
    display: block !important;
  }
  .headerTop .leftAll .menu-box .row{
    display: none;
  }
